...
from src.utils.phase12_verify import (
    ...
    load_config,
    parse_args as _unused_phase12_parse_args,
    resolve_checkpoint,
    resolve_run_config,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Recompute and cross-check phase-13 metrics from a saved checkpoint.")
...
def main() -> None:
    ...
    out_path = (
        ...
        else run_dir / "artifacts" / "phase13_verify" / "verification.json"
    )

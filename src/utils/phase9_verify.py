...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Recompute and cross-check phase-9 metrics from a saved checkpoint.")
...
def main() -> None:
    ...
    out_path = Path(args.out) if args.out else run_dir / "artifacts" / "phase9_verify" / "verification.json"

...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Recompute and cross-check phase-14 metrics from a saved checkpoint.")
...
def main() -> None:
    ...
    out_path = (
        ...
        else run_dir / "artifacts" / "phase14_verify" / "verification.json"
    )

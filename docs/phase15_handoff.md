...
- `18026` paneling is now active at depth, with `18226` and `18227` banked and `18228` live.
- `18060` stronger sidecar paneling has started with `18260` live.
...
Complete the `18026` multislot panel root and the `18060` stronger-sidecar panel root so the sidecar-vs-multislot comparison is locked in at panel depth before spending more budget on portability.

...
- Therefore the remaining frontier is the weighted teacher-backed hard-slice branch `17042` plus the `17043` no-teacher panel control, not more dual-anchor discovery, more plain teacher-first repetition, or more first-pass sidecar discovery.

The active verification queue has already rolled past `17041` and is now executing the `17043` no-teacher panel root.

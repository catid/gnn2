...
- Therefore the remaining frontier is the weighted teacher-backed hard-slice branch `17042` plus the bounded Cluster F sanity batch, not more dual-anchor discovery, more plain teacher-first repetition, or more first-pass sidecar discovery.

The active queue has already rolled past `17043` and is now executing the bounded Cluster F sanity pair (`17101`, `17103`).

...
- Therefore the remaining frontier is the teacher-backed hard-slice lane (`17041`, `17042`), not more dual-anchor discovery or more plain teacher-first repetition.
